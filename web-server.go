...
// newer link >> https://stackoverflow.com/questions/39320025/how-to-stop-http-listenandserve/42533360#42533360
...
`
  // i don't really know Go, but reviewing this line and that's an interesting feature.
  // tldr adding style to the printed output
	fmt.Println("\033[1;36m" + banner + "\033[0m")
  
}

func randomFact() string {
  // so we have := for assigning
  // enforced typing of an array, similar syntax to TypeScript but reversed
	facts := []string{
